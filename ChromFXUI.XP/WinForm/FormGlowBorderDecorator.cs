...
namespace ChromeFX.WinForm.ShadowForm
{
	...
	/// 窗口投影装饰器
	/// </summary>
	public class FormGlowBorderDecorator : NativeWindow, IShadowForm
	{
		private IntPtr parentWindowHWnd => parentWindow.Handle;
		private Form parentWindow;

		private FormGlowBorderElement topShadowForm;
		private FormGlowBorderElement leftShadowForm;
		private FormGlowBorderElement bottomShadowForm;
		private FormGlowBorderElement rightShadowForm;
